...
export default function AccessoriesPage() {
  const products = [
    { name: 'Crest Snapback', price: 'R499' },
    { name: 'Luxury Duffel Bag', price: 'R1,299' },
    { name: 'Crest Socks (2 Pack)', price: 'R199' },
    { name: 'Crest Pendant', price: 'R599' },
  ];
    ...
    <main style={{ background: '#0B0B0B', color: 'white', minHeight: '100vh', fontFamily: 'Arial' }}>
      ...
      <section style={{ padding: '56px 24px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#ddd', maxWidth: 620, margin: '0 auto' }}>
          Complete your Sovereign Crest look with premium caps, bags, jewelry, and essentials.
        </p>
      </section>
