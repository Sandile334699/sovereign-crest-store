...
export default function WomenPage() {
  const products = [
    { name: 'Crown Women Hoodie', price: 'R1,299' },
    { name: 'Luxe Crop Tee', price: 'R499' },
    { name: 'Crest Leggings', price: 'R799' },
    { name: 'Premium Sweatshirt', price: 'R999' },
  ];
    ...
    <main style={{ background: '#0B0B0B', color: 'white', minHeight: '100vh', fontFamily: 'Arial' }}>
      ...
      <section style={{ padding: '56px 24px', textAlign: 'center' }}>
        ...
        <p style={{ color: '#ddd', maxWidth: 620, margin: '0 auto' }}>
          Elevated women's streetwear featuring premium hoodies, crop tees,
          leggings, and luxury essentials designed for confidence and comfort.
        </p>
      </section>
